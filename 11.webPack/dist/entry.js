...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__test_scss__ = __webpack_require__(6);
...
// module
exports.push([module.i, "body{\r\n    width: 100%;\r\n    height: 100%;\r\n    background: red;\r\n}\r\n#img{\r\n    width: 300px;\r\n    height: 500px;\r\n    /* 引入图片需要两个loader */\r\n    /* file-loader:解决引用路径的问题 */\r\n    /* url-loader:可以把图片转换成base64位编码 */\r\n    background: url('https://ss2.bdstatic.com/8_V1bjqh_Q23odCf/pacific/987777674.png');\r\n}", ""]);
...
if(false) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept("!!../node_modules/_css-loader@0.28.7@css-loader/index.js!../node_modules/_sass-loader@6.0.6@sass-loader/lib/loader.js!./test.scss", function() {
			var newContent = require("!!../node_modules/_css-loader@0.28.7@css-loader/index.js!../node_modules/_sass-loader@6.0.6@sass-loader/lib/loader.js!./test.scss");
			if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
			update(newContent);
		});
	}
